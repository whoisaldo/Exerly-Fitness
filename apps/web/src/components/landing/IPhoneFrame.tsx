    ...
    >
      <div className="relative overflow-hidden rounded-[2.55rem] bg-deep px-4 pb-4 pt-3">
        ...
        <div className="mb-4 flex items-center justify-between px-1">
          ...
          <span className="flex h-8 w-8 items-center justify-center rounded-xl border border-white/8 bg-surface-2">
        ...
        {/* Calorie ring card */}
        <div className="mb-3 rounded-2xl border border-white/8 bg-surface-2 p-4">
        ...
        <div className="mb-3 grid grid-cols-3 gap-2">
          {MINI_STATS.map((s) => (
            <div
              key={s.label}
              className="rounded-xl border border-white/8 bg-surface-2 px-1 py-2.5 text-center"
            >
        ...
        {/* Streak card */}
        <div className="mb-4 flex items-center gap-2.5 rounded-2xl border border-white/8 bg-surface-2 p-3">
        ...
        {/* Tab bar */}
        <div className="flex items-center justify-between rounded-2xl border border-white/8 bg-surface-2 px-5 py-2.5">
          <span className="h-1.5 w-5 rounded-full bg-primary" />
          <span className="h-1.5 w-5 rounded-full bg-white/12" />
